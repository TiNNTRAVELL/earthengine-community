...
// It is occastionally useful for forcing computation or visualization at a
...
// is essenstially meaningless and difficult to even display.
...
var slopeTransform = ee.Terrain.slope(demMeanReproj);
Map.addLayer(slopeTransform, {min:0, max: 45}, 'Slope w/ reference projection');
print('Reference projection', nasademProj);
print('DEM composite projection', demMeanReproj.projection());

// Despite the utility of ee.Image.reproject in this example, a better method
// would be to use ee.Image.setDefaultProjection on the DEM composite.
