...
// [START earthengine__apidocs__ee_imagecollection_product]
...
// ee.ImageCollection.mode returns the most common value. If all values are
// unique, the minimum value is returned.
var mode = col.mode();
...
// image pixels are masked based on cloud probably to add valid observation
...
// invalid (mask value 1) pixels are filled by preceding valid (mask value 1)
// pixels.
var mosaic = notCloudCol.mosaic();
Map.addLayer(mosaic, visRefl, 'Mosaic (B11, B8, B3)');
// [END earthengine__apidocs__ee_imagecollection_product]
